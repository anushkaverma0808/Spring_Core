...
public class ProductDaoMapImpl implements ProductDao{
	...
	public ProductDaoMapImpl() {
		...
		productsMap.put(1, new Product("desktop", new BigDecimal(55000), true));
		productsMap.put(2, new Product("Mouse pad", new BigDecimal(550), true));
		productsMap.put(3, new Product("Torch", new BigDecimal(520), false));
		counter=3;
